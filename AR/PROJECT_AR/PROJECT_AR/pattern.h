...
class Pattern
{
	public:
		...
		void draw(Mat& frame, const Mat& camMatrix, const Mat& distMatrix, const Mat& imageNewPts, std::vector<cv::Point2f> imagOriPts, const Mat& newImag);
